		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Merkez Masraf Giris",
									"targetURL": "#MerkezMasrafGiris-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MerkezMasrafGiris-display": {
								"semanticObject": "MerkezMasrafGiris",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=eve.ui.Z_MMASRAF01",
									"url": sap.ui.require.toUrl("eve/ui/Z_MMASRAF01")
								}
							}
						}
					}
